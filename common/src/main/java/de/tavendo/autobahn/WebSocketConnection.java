...
public class WebSocketConnection implements WebSocket {
	...
	private void handleMessage(Message message) {
		...
		if (message.obj instanceof WebSocketMessage.TextMessage) {
			...
			Log.d(TAG, "WebSockets Pong received" + Arrays.toString(pong.mPayload));
    ...
    public void ping() {
        WebSocketMessage.Ping ping = new WebSocketMessage.Ping("Android".getBytes());
        mWebSocketWriter.forward(ping);
    }

    public Runnable onPong;
